                ...
                <div class="topbar-menu-area">
                    <div class="container">
                        <div class="topbar-menu left-menu">
                            <ul>
                                <li class="menu-item">
                                    <a title="Hotline: (+84) 333 501 404" href="#"><span
                                            class="icon label-before fa fa-mobile"></span>Hotline: (+84) 333 501 404</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="coppy-right-box">
                    <div class="container">
                        <div class="coppy-right-item =">
                            <p class="coppy-right-text">Copyright © 2021 NANGTX All rights reserved</p>
                        </div>
